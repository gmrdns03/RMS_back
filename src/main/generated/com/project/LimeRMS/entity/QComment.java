...
public class QComment extends EntityPathBase<Comment> {
    ...
    public final NumberPath<Long> commendId = createNumber("commendId", Long.class);
    ...
    public final QComment hiComment;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.hiComment = inits.isInitialized("hiComment") ? new QComment(forProperty("hiComment"), inits.get("hiComment")) : null;
